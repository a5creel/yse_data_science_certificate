---
title: "Data Manipulation with Tidyverse, Part I"
author: "Andie Creel"
output: 
  pdf_document:
...
How I'd recommend following along for this lecture and the next: have the pdf notes in front of you so you can follow along some of the points, but mostly write the code and comments in a script (or R markdown if you're comfortable). 

In this lecture and the next, we're going to go through a lot of different concepts. I've tried to write these lecture notes so you can use it as a reference to refer back to in the future. 
